...
* registered classes are now NativeVideoStream, NativeVideoStreamPlayback, and NativeVideoResourceFormatLoader; the extension file is native-video.gdextension with entry symbol native_video_init. Resources saved against the old class names must be re-created.
...
* **ci:** skip freq groups on Dummy driver, fix Windows Godot.exe rename ([ad40cdf](https://github.com/claytercek/godot-native-video/commit/ad40cdf7a8f543cd13e3e23cc1fb11ae1663f144))
...
* **core:** bounded backoff for exact-resolve spin, not yield hot-loop ([9e7b15a](https://github.com/claytercek/godot-native-video/commit/9e7b15ab3c45a0e0335df5e9db622a76643fefc2))
...
* **common:** shrink Binding to a PlaybackController adapter ([2cd88de](https://github.com/claytercek/godot-native-video/commit/2cd88de0d5dbd882c9d5467928b305862d462a6b))
...
* **core:** extract Canonical Mix Format derivation as pure helper ([6fb7c24](https://github.com/claytercek/godot-native-video/commit/6fb7c24ca278daf6249c0ae13cee53e9b3d3c4db))
* **core:** extract Godot-free PlaybackController ([6cf6a75](https://github.com/claytercek/godot-native-video/commit/6cf6a758b7dbea2a03a931c3cc927dc8623b1825))
* **core:** extract one-clock rule into advance_master_clock ([f50f6cb](https://github.com/claytercek/godot-native-video/commit/f50f6cb247c5e0beebd513193c089bdaf67521c1))
* **core:** trim what-comments in playback_controller, keep why ([14a9dc3](https://github.com/claytercek/godot-native-video/commit/14a9dc3cbf20c3239deb574d2720d1be609579d1))
* **core:** type now_ms contract as WallClockMs ([88c3099](https://github.com/claytercek/godot-native-video/commit/88c3099ea773346a4c7746fa799f668ac6aab3d9))
...
* rename project to Native Video ([e417d6a](https://github.com/claytercek/godot-native-video/commit/e417d6a3330c2c2283cf11e5992e08c197528739))
...
* **smoke:** rewrite suite as sequential coroutine ([0d9bf89](https://github.com/claytercek/godot-native-video/commit/0d9bf8994b9e0c6975b4719b3b30848844271b05))
* **smoke:** share run/verify + clip staging with CI ([77f0cbf](https://github.com/claytercek/godot-native-video/commit/77f0cbfbbfe61a1995085935d22fd02621ee27a8))
