...
// GPU->CPU readback so the decoded NV12/P010 surface reaches Godot RD as
// ordinary R8/RG8 (8-bit) or R16/RG16 (10-bit) textures instead of an aliased
// import.
//
...
//   2. GPU-blit (CopySubresourceRegion, no CPU copy yet) the decoder's
//      NV12/P010 slice into the next slot of an N-buffered ring of
//      CPU-readable D3D11 staging textures.
...
//   5. RD::texture_create (R8/R16 luma, RG8/RG16 chroma) + RD::texture_update.
//      Freed by the release closure the retire-ring runs after
//      PresentPipeline::kFrameLatency rendered frames, exactly like the other
//      two Import Paths' transient textures.
// -----------------------------------------------------------------------
